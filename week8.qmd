...
## 7.1.3 Process (workflow)


### 7.1.3.1  cross validation--spatial autocorrelation

spatial cross validation

## 7.1.4 Practical

### 7.1.4.1 Sub-pixel analysis
...
::: {layout-ncol="2"}
![Figure 6.Daressalaam constrained fractions ](images/8_D_constrained_fractions.png)

![Figure 7.Taiyuan constrained fractions ](images/8_TY_constrained_fractions.png)
:::
...
![Figure 6.Daressalaam OBIA ](images/8_D_classified_40.png)

![Figure 7.Taiyuan OBIA ](images/8_TY_classified_40.png)
...
![Figure 1.Supervised classification algorithm selection [@]](images/7_supn.png){#fig-algorithm width="80%" fig-align="center"}
...
However, in a tropical city like DaresSalaam, where houses and trees are deeply intertwined, fragmented structures actually become noise. For that kind of landscape, using NDVI and spectral unmixing to break down the pixel components is the real 'secret weapon' for revealing the truth.
